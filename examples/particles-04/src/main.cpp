...
private:
    ...
    rc<ParticleSystem> rocketParticleSystem = {};
    rc<ParticleSystem> sparkleParticleSystem = {};
    rc<ParticleSystem> explosionParticleSystem = {};
    rc<ParticleEmitter> rocketParticleEmitter = {};
